...
<div class="w-[390px] h-[7168px] flex-col justify-start items-center gap-2.5 inline-flex">
 <div class="h-[2980px] flex-col justify-start items-center gap-10 flex">
  ...
  <div class="w-full h-64 relative inline-flex">
	<div class="w-1/3 h-32 space-x-4">
	  ...
	  <div class="w-1/3 h-32 relative text-sky-950 text-4xl font-semibold leading-tight">Connecting Businesses, Innovating Communications</div>
	  <div class="w-80 top-20 relative text-stone-950/opacity-60 text-base font-normal leading-tight">Provides a brief overview of the company's specialization in providing VoIP services to small and medium-sized businesses.</div>
	</div>
  </div>
  ...
  <div class="w-[310px] h-[696px] p-5 bg-white rounded-3xl shadow flex-col justify-center items-center gap-[25px] inline-flex">
	<div class="text-[#052f47]/60 text-base font-normal font-['Khula'] leading-[31px]">GET YOUR FREE QUOTE NOW</div>
	<div class="self-stretch h-[50px] px-5 py-2.5 bg-white rounded-2xl border border-[#052f47] justify-start items-center gap-2.5 inline-flex">
	  <div class="w-[95px] h-[23px] text-[#052f47]/60 text-base font-normal font-['Khula'] leading-[31px]">First Name</div>
	</div>
	<div class="self-stretch h-[50px] px-5 py-2.5 bg-white rounded-2xl border border-[#052f47] justify-start items-center gap-2.5 inline-flex">
	  <div class="w-[95px] h-[23px] text-[#052f47]/60 text-base font-normal font-['Khula'] leading-[31px]">Last Name</div>
	</div>
	<div class="self-stretch h-[50px] px-5 py-2.5 bg-white rounded-2xl border border-[#052f47] justify-between items-center inline-flex">
	  <div class="w-[67px] h-6 relative">
		<div class="w-[31px] h-4 left-0 top-[8px] absolute text-[#052f47]/60 text-base font-normal font-['Khula'] leading-[31px]">+1</div>
		<img class="w-[31px] h-6 left-[36px] top-0 absolute" src="https://via.placeholder.com/31x24" />
	  </div>
	  <div class="w-[139px] h-[23px] text-center text-[#052f47]/60 text-base font-normal font-['Khula'] leading-[31px]">Phone Number</div>
	</div>
	<div class="self-stretch h-[50px] px-5 py-2.5 bg-white rounded-2xl border border-[#052f47] justify-between items-center inline-flex">
	  <div class="w-[134px] h-[49px]"><span style="text-[#052f47]/60 text-sm font-normal font-['Khula'] leading-tight">Country/Region</span><span style="text-[#052f47]/60 text-base font-normal font-['Khula'] leading-tight">     </span><span style="text-[#052f47] text-base font-normal font-['Khula'] leading-tight">Select</span></div>
	  <img class="w-[31px] h-6" src="https://via.placeholder.com/31x24" />
	</div>
	<div class="self-stretch h-[50px] px-5 py-2.5 bg-white rounded-2xl border border-[#052f47] justify-between items-center inline-flex">
	  <div class="w-[90px] h-[49px]"><span style="text-[#052f47]/60 text-sm font-normal font-['Khula'] leading-snug">Industry</span><span style="text-[#052f47]/60 text-base font-normal font-['Khula'] leading-tight">     </span><span style="text-[#052f47] text-base font-normal font-['Khula'] leading-tight">Select</span></div>
	  <img class="w-[31px] h-6" src="https://via.placeholder.com/31x24" />
	</div>
	<div class="self-stretch h-[50px] px-5 py-2.5 bg-white rounded-2xl border border-[#052f47] justify-between items-center inline-flex">
	  <div class="w-[90px] h-[49px]"><span style="text-[#052f47]/60 text-sm font-normal font-['Khula'] leading-tight">Employers</span><span style="text-[#052f47]/60 text-base font-normal font-['Khula'] leading-tight">     </span><span style="text-[#052f47] text-base font-normal font-['Khula'] leading-tight">Select</span></div>
	  <img class="w-[31px] h-6" src="https://via.placeholder.com/31x24" />
	</div>
	<div class="h-[150px] flex-col justify-start items-center gap-2.5 flex">
	  <div class="self-stretch h-20 p-4 bg-[#fdfcfb] rounded justify-start items-start gap-2 inline-flex">
		<div class="w-6 h-6 relative"></div>
		<div class="grow shrink basis-0 text-[#052f47] text-base font-normal font-['Khula'] leading-tight">This is a form element that is very long and will become taller the more text that is in it. </div>
	  </div>
	  <div class="w-[220px] h-[60px] px-[55px] py-3.5 bg-[#f68737] rounded-2xl shadow justify-center items-center gap-2.5 inline-flex">
		<div class="w-[87px] h-[25px] text-white text-base font-normal font-['Khula'] leading-[31px] tracking-wide">Get started</div>
	  </div>
	</div>
  </div>

  <div class="h-[117px] px-[25px] py-2.5 bg-[#20ccf8] flex-col justify-center items-center gap-5 inline-flex">
	<div class="text-center text-[#ebfeff] text-[26px] font-semibold font-['Khula'] leading-[38px] tracking-[2.60px]">Trusted By 200k+   Business</div>
  </div>
</div>
</div>
